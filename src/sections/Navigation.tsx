    ...
    >
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          className="nav-brooch"
          style={{
            position: 'absolute',
            width: 'clamp(22px, 2.5vw, 32px)',
            top: '-10px',
            right: 'clamp(70px, 9vw, 110px)', /* Ajustado para estar sobre ES/EN */
            transform: 'rotate(-20deg)',
            filter: 'drop-shadow(0 3px 6px rgba(212, 132, 156, 0.3))',
            pointerEvents: 'none',
            zIndex: 10,
          }}
        />
        ...
        <div className="nav-mobile-actions" style={{ display: 'none', alignItems: 'center', gap: '8px' }}>
          ...
          <button
            ...
            className="nav-menu-toggle font-body"
            style={{
              fontSize: '10px',
              fontWeight: 600,
              color: 'var(--ink)',
          ...
          >
            {isMobileMenuOpen ? (lang === 'es' ? 'Cerrar' : 'Close') : 'Menu'}
          </button>
        </div>
        ...
        <div
          ...
          style={{
            ...
            gap: '6px',
            borderTop: '1px solid rgba(61, 43, 31, 0.16)',
            paddingTop: '10px',
          }}
        >
          <button
